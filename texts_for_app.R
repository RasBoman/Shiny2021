...
tab1_ohjeet <- wellPanel(p(paste("Tämä sovellus on tarkoitettu VELMU-muotoisen kartoitusaineiston tarkastamiseen",
                                               "Sovellukseen on ladattu esimerkkitaulukko,",
                                               "ja ladattuasi oman taulukon välilehtien tulisi näyttää suurin piirtein samalta.",
